...
- Phase 1B runtime-command bridge started:
  ...
  - Preset slots may intentionally omit `action`; these unassigned placeholders render disabled/locked, are skipped by action id validation and hotkey publishing, and do not show missing-action diagnostics.
