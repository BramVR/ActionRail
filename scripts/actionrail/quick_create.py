...
_TEMPLATES = (
    QuickCreateTemplate(
        ...
        slots=(
            QuickCreateSlotInput("slot_1", "", key_label="1"),
            QuickCreateSlotInput("slot_2", "", key_label="2"),
            QuickCreateSlotInput("slot_3", "", key_label="3"),
            QuickCreateSlotInput("slot_4", "", key_label="4"),
            QuickCreateSlotInput("slot_5", "", key_label="5"),
            QuickCreateSlotInput("slot_6", "", key_label="6"),
        ),
    ),
    QuickCreateTemplate(
        id="vertical_stack",
