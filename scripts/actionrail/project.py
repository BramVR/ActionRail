    ...
    return {
        ...
        "status": {
            "phase": (
                ...
                "action plus selection/viewport/modeling entries and a "
                "20-action shelf-derived polygon modeling pack Maya-smoke "
                "verified with saved catalog artifact; Quick Create "
                "blank-bar default and simplified slot editor Maya-smoke verified; "
                "public "
